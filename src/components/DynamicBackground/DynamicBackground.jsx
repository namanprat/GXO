...
// ponytail: live canvas clear color for scroll bg scrub
export const dynamicBgState = { canvasBg: "#999136" };

const LOGO_PATH = "/images/logos/logo_light.png";
...
const DynamicBackground = () => {
  ...
  useEffect(() => {
    ...
    const loadLogo = () => {
      ...
      image.onerror = () => {
        console.error("Failed to load logo image:", LOGO_PATH);
      };
    ...
    function startAnimation() {
      function animate() {
        ...
        const bgColor = hexToRgb(dynamicBgState.canvasBg);
